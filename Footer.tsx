        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="p-2 bg-blue-600 rounded-xl transition-transform transform hover:scale-110">
          ...
          <div className="space-y-4">
            ...
            {/* Emergency Hotline */}
            <div className="bg-red-600 p-4 rounded-lg mt-4 transition-transform transform hover:scale-105">
