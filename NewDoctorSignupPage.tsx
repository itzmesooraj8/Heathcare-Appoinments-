...
import "./DoctorSignupPage.css"; // Reuse the same styles

function NewDoctorSignupPage() {
  ...
  return (
    <div className="signup-page">
      <h1>Register as a New Doctor</h1>
      <p>Sign up to join our healthcare network</p>
      <form onSubmit={handleSubmit} className="signup-form">
        <div className="role-selection">
          <label>Select your role</label>
          <div className="roles">
            <button type="button" className="role new-doctor active">
              New Doctor
            </button>
          </div>
        </div>
...
export default NewDoctorSignupPage;
